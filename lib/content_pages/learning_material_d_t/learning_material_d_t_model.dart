...
import 'learning_material_d_t_widget.dart' show LearningMaterialDTWidget;
...
class LearningMaterialDTModel
    extends FlutterFlowModel<LearningMaterialDTWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (youtubeSearch)] action in learningMaterialDT widget.
