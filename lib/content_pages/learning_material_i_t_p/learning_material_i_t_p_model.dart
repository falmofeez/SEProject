...
import 'learning_material_i_t_p_widget.dart' show LearningMaterialITPWidget;
...
class LearningMaterialITPModel
    extends FlutterFlowModel<LearningMaterialITPWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (youtubeSearch)] action in learningMaterialITP widget.
