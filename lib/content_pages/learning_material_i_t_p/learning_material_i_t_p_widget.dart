...
import 'learning_material_i_t_p_model.dart';
export 'learning_material_i_t_p_model.dart';

class LearningMaterialITPWidget extends StatefulWidget {
  const LearningMaterialITPWidget({Key? key}) : super(key: key);

  @override
  _LearningMaterialITPWidgetState createState() =>
      _LearningMaterialITPWidgetState();
}

class _LearningMaterialITPWidgetState extends State<LearningMaterialITPWidget>
    with TickerProviderStateMixin {
  late LearningMaterialITPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LearningMaterialITPModel());
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            child: LectureWidget(
                                              ...
                                              description:
                                                  'introduces beginners to the fundamental \nconcepts of programming using the Java \nlanguage as a practical and hands-on approach.',
                                            ),
                                          ),
                                        ),
                                        InkWell(
                                        ...
                                        InkWell(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            child: LectureWidget(
                                              title:
                                                  '3 Fundamentals - Numeric Data',
                                              description:
                                                  'introduces essential concepts of numeric data\n types and operations for mathematical \ncomputations and data manipulation.',
                                            ),
                                          ),
                                        ),
                                        InkWell(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: LectureWidget(
                                              title: '4 Fundamentals - Arrays',
                                              description:
                                                  'explores the basics of arrays, including their \ndeclaration, initialization, manipulation, and \ncommon operations for efficient data storage.',
                                            ),
                                          ),
                                        ),
                                        InkWell(
                                          ...
                                          child: wrapWithModel(
                                            ...
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: LectureWidget(
                                              title: '5 Fundamentals - String',
                                              description:
                                                  'focuses on the basics of string handling,\ncovering operations like concatenation, \nmanipulation, and substring extraction.',
                                            ),
                                          ),
                                        ),
                                      ]
