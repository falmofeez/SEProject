...
import 'learning_material_copy_model.dart';
export 'learning_material_copy_model.dart';

class LearningMaterialCopyWidget extends StatefulWidget {
  const LearningMaterialCopyWidget({Key? key}) : super(key: key);

  @override
  _LearningMaterialCopyWidgetState createState() =>
      _LearningMaterialCopyWidgetState();
}

class _LearningMaterialCopyWidgetState extends State<LearningMaterialCopyWidget>
    with TickerProviderStateMixin {
  late LearningMaterialCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LearningMaterialCopyModel());
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'cg1pbtio' /* Oriented Objective Programming */,
                  ),
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          16.0),
                                                  child: Image.network(
                                                    'https://images.app.goo.gl/doafeduudfSzeZam9',
                                                    width: double.infinity,
                                                    height: 230.0,
                                                    fit: BoxFit.cover,
                                                  ),
