                        ...
                        if (FFAppState().addFavITP)
                          Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed('learningMaterialITP');
                              },
                              child: Container(
                                width: 340.0,
                                height: 80.0,
                    ...
                    if (FFAppState().addFavOOP)
                      Align(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('learningMaterialOOP');
                          },
                          child: Container(
                            width: 340.0,
                            height: 80.0,
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('learningMaterialDT');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
